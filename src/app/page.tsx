          ...
          <div className="grid gap-4">
            {states.map((state) => (
              <button
                ...
                className="group bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-200 p-6 text-left border border-gray-200 hover:border-blue-300 hover:scale-105"
              >
